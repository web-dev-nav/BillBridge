...
<body
    ...
    <table class="wrapper" width="50%" cellpadding="0" cellspacing="0" role="presentation"
                ...
                <table class="content" width="100%" cellpadding="0" cellspacing="0" role="presentation"
                    ...
                    <tr>
                        <td class="body" width="100%" cellpadding="0" cellspacing="0"
                            ...
                            role="presentation"
                            style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; -premailer-cellpadding: 0; -premailer-cellspacing: 0; -premailer-width: 500px; background-color: #ffffff; border-color: #e8e5ef; border-radius: 2px; border-width: 1px; box-shadow: 0 2px 0 rgba(0, 0, 150, 0.025), 2px 4px 0 rgba(0, 0, 150, 0.015); margin: 0 auto; padding: 0; width: 500px;">
                                <tr>
                                    <td class="content-cell"
                                        ...
                                        <p
                                            ...
                                            {{ __('messages.common.hello') }},</p>
                                        <p
                                            style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                            {{ __('auth.reset_password.reset_password_msg') }}</p>
                                                                    ...
                                                                    <tr>
                                                                        <td
                                                                            ...
                                                                            <a href="{{ $url }}"
                                                                                ...
                                                                                {{ __('auth.reset_password.reset_pwd_btn') }}</a>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                                        ...
                                        <p
                                            style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                            {{ __('auth.reset_password.reset_password_msg3', ['count' => config('auth.passwords.' . config('auth.defaults.passwords') . '.expire')]) }}
                                            <br>
                                            {{ __('auth.reset_password.reset_password_msg2') }}
                                        </p>
                                        <p
                                            style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                            {{ __('messages.common.regards') }}<br>
                                            {{ config('app.name') }}</p>
                                                ...
                                                <td
                                                    ...
                                                    <h6>
                                                        <div style="overflow-wrap: break-word;">
                                                            {{ __('auth.reset_password.reset_password_msg4') }}:
                                                            <a href="{{ $url }}">{{ $url }}</a>
                                                        </div>
                                                    </h6>
                                                </td>
