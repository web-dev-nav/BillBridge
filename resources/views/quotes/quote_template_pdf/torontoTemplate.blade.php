...
<body style="padding: 0rem 0rem !important;">
    ...
    <div class="mb-8 w-100 position-relative px-3"
        ...
        <table class="w-100">
            <tr>
                ...
                <td style="vertical-align:top; width: 50% !important; padding: 0rem 2rem 0rem 0rem ;">
                    <table class="w-100">
                        <thead class="">
                            <tr>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="pr-5"
                                    ...
                                    <span>{{ $setting['company_phone'] }}</span><br>
