                    ...
                    <div>
                        ...
                        <div class="px-3">
                            <table class="invoice-table w-100">
                                <thead style="background-color: {{ $invoice_template_color }};">
                                    <tr>
                                        ...
                                        <th class="py-1  fs-5 in-w-2 text-start">
                                            {{ __('messages.product.product') }}</th>
                                        <th class="py-1 p fs-5 text-center" style="width:9% !important;">
                                            {{ __('messages.invoice.qty') }}</th>
                                        <th class="py-1 fs-5 text-center text-nowrap" style="width:15% !important;">
                                            {{ __('messages.product.unit_price') }}</th>
                                        <th class="py-1  fs-5 text-center text-nowrap" style="width:13% !important;">
                                            {{ __('messages.invoice.tax') . '(in %)' }}</th>
                                        <th class="py-1 px-2 fs-5 text-end text-nowrap" style="width:14% !important;">
                                ...
                                <tbody>
                                    @if (!empty($invoice))
                                        @foreach ($invoice->invoiceItems as $key => $invoiceItems)
                                            <tr>
                                                <td class="px-2" style="width:5%; vertical-align: top;">
                                                    <span>{{ $key + 1 }}</span>
                                                </td>
                                                ...
                                                <td class=" text-center text-nowrap font-gray-600"
                                                ...
                                                <td class="text-end text-nowrap font-gray-600 px-2"
                                ...
                                <table class="w-100">
                                    <tr>
                                        ...
                                        {{ $invoice_template_color }}">
                                                ...
                                                <img class="mt-2 ml-3" src="{{ $qrImg }}" height="110"
                            ...
                            <div class="mt-5">
                                ...
                                @endif
                                <div class="w-25 text-end" style="position:relative; top:-50px; margin-left:auto;">
                                    <h4 class="fw-6 mb-0"
                                        style="color:
                                            {{ $invoice_template_color }}">
