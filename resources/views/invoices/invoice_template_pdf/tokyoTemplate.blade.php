    ...
    <div class="preview-main client-preview tokyo-template">
        <div class="d" id="boxes">
            <div>
                <table class="mb-3 w-100">
                    <tr>
                        ...
                        <td class="heading-text">
                            <div class="text-end">
                                <h1 class="m-0 text-black text-end"
                                    {{ $styleCss }}="color:
                        ...
                        <tbody>
                            <tr style="vertical-align:top;">
                                <td width="36.33%">
                                    ...
                                    <p class=" mb-1 font-color-gray fs-6">{{ __('messages.common.name') . ':' }}
                                ...
                                <td width="36.33%">
                                    ...
                                    <p class="font-color-gray fw-bold fs-6">
                                    ...
                                    @if (isset($setting['show_additional_address_in_invoice']) && $setting['show_additional_address_in_invoice'] == 1)
                                        <p class=" m-0 font-gray-900 fs-6 py-2">
                                ...
                                <td width="33.33%" class="text-end pt-7">
                                    <p class="mb-1 text-gray-600 fs-6 py-2"><strong
                    ...
                    <table class="invoice-table w-100">
                        <thead {{ $styleCss }}="background-color: {{ $invoice_template_color }};">
                            <tr>
                                ...
                                <th class="py-1 px-2 text-center" style="width:9% !important;">
                                    {{ __('messages.invoice.qty') }}
                                </th>
                                <th class="py-1 px-2 text-center text-nowrap" style="width:20% !important;">
                                    {{ __('messages.product.unit_price') }}</th>
                                <th class="py-1 px-2 text-center text-nowrap" style="width:20% !important;">
                                    {{ __('messages.invoice.tax') . '(in %)' }}
                                </th>
                                <th class="py-1 px-2 text-end text-nowrap" style="width:14% !important;">
                ...
                <div class="my-4" style="display:flex;justify-content:">
                        ...
                        <tr>
                            ...
                            <td class="w-25 text-end">
                                <table class="w-100">
                                    <tbody>
                                        <tr>
                                            <td class="py-2 px-0 font-dark-gray text-nowrap">
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-end font-gray-600 py-2 px-0 fw-bold text-nowrap">
                                    ...
                                    <tfoot class="total-amount">
                                        <tr>
                                            <td class="py-2 pt-1 font-dark-gray text-nowrap">
                                                <strong>{{ __('messages.admin_dashboard.total_due') . ':' }}</strong>
                                            </td>
                                            <td class="text-end pt-1 font-dark-gray py-2 fw-bold text-nowrap">
                ...
                <div class="mt-20">
                    ...
                    @if (!empty($invoice->term))
                        <div class="w-50">
                            <div>
                                <h4 class="font-gray-900 mb5"><b>{{ __('messages.invoice.terms') . ':' }}</b>
                                </h4>
